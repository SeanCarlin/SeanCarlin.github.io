...
// Earth
planets.push(new Planet(0.5*(innerWidth-screenDistance(384400000)),c.height/2,0,0,screenDistance(earthRadius),earthMass,false,"Earth"));

// Moon
planets.push(new Planet(0.5*(innerWidth-screenDistance(384400000))+screenDistance(384400000),c.height/2,0,0,screenDistance(1737000),moonMass,false,"Moon"));
